...
4. **ArgoWorkflowBuilder** – Defines the Argo Workflow to build, upload, and register the NixOS image.
5. **NixOSImageSecret** – (Optional) Mocks or writes the image slug into a `Secret`. Can be omitted if handled by the Workflow.
